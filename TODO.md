...
- [ ] to_int(String) → Result<Int, ParseError> — Logs Insights returns counts as strings.
- [ ] Fixed-decimal float formatting — float.format(x, decimals); shortest-round-trip can't render 97.8.
