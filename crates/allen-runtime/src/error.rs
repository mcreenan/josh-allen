...
impl RuntimeErrorCode {
    ...
    pub const fn as_str(self) -> &'static str {
        match self {
            ...
            Self::EntryInvariantInput => "runtime.entry_invariant.input",
            Self::EntryInvariantOutput => "runtime.entry_invariant.output",
...
pub(crate) fn runtime_vm_error_code(error: &VmError) -> RuntimeErrorCode {
    match error {
        ...
        VmError::ListLengthMismatch => RuntimeErrorCode::ListLengthMismatch,
        ...
        VmError::ProgramFailed { .. } => RuntimeErrorCode::ProgramFailed,
...
pub(crate) const fn safe_terminal_message(code: RuntimeErrorCode) -> &'static str {
    match code {
        ...
        RuntimeErrorCode::ProgramFailed => "program failed",
